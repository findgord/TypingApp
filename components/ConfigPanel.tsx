...
import { Sliders, RefreshCw, Keyboard, Mic, FileText } from 'lucide-react';
...
export const ConfigPanel: React.FC<Props> = ({ 
  mode, setMode, difficulty, setDifficulty, topic, setTopic, inputMode, setInputMode, onApply, disabled 
}) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl border border-brand-accent shadow-sm p-6 flex flex-col gap-6 h-full transition-colors duration-300">
      ...
      <div className="space-y-6 flex-grow flex flex-col">
        ...
        {/* Conditional Render: Difficulty or Custom Text Area */}
        {isCustomMode ? (
